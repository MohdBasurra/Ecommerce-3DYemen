...
const ProductDescription = () => {
  ...
  <div className='h-full flex flex-col '>
    <div className="title text-2xl sm:text-4xl     font-bold text-start   p-6 pb-12"><h1>Ender 3 pro V2 3D printer</h1></div>
    <hr/>


    <div className='pl-2 sm:pl-8'>
 <div className='price parent order-1 flex justify-center sm:justify-start  '>
 <div className="price text-2xl p-4 sm:text-4xl font-bold flex flex-col sm:p-6 ">199$</div>
    ...
    <div className=' flex justify-start   '><Counter/></div></div>

    
    

    <div className='description  p-4 sm:order-2'><p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iure, ratione architecto aperiam illo quam non doloribus accusamus porro ipsa vel dolorum. Sit officia accusantium, vitae molestiae dignissimos pariatur eos soluta, doloribus consequuntur tempore deserunt laboriosam quasi aliquid sapiente veniam reiciendis ad ipsam accusamus omnis dolore distinctio nam ducimus, quae at!</p>
