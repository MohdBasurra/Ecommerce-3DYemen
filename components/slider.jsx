...
<div className="parent sm:w-1/2 w-full flex flex-col sm:flex-row rounded border-custom-blue border-solid border-8 ">
        <div className='child1 bg-custom-blue w-full sm:w-1/3 sm:text-2xl  text-2xl justify-start items-center text-white font-bold p-2 '><h1>Creality Ender Series 3D Printer</h1> 
        <div className='child2 pt-8  sm:w-1/6 text-sm  '>
            <Button textColor ={'gray-900'} color={'white'} text={'see more'}  size={'medium'}/></div></div>
    <div className='  sm:w-2/3 justify-center items-center'>
