      ...
      <div className="flex flex-col items-center justify-center w-full">
        ...
        <div className="flex flex-row  md:ml-4 w-full gap-2 justify-center p-8 items-center">
          ...
          >
            <Image
              alt="dsf"
              src="https://m.media-amazon.com/images/I/41AyZR+YfLL._SX342_SY445_.jpg"
              width={`${
                selectedImage ===
                "https://m.media-amazon.com/images/I/41AyZR+YfLL._SX342_SY445_.jpg"
                  ? 120
          ...
          <div
            className={`cursor-pointer ${
              selectedImage ===
              "https://m.media-amazon.com/images/I/413Qxx3iX4L._SY445_SX342_QL70_ML2_.jpg"
                ? "border-4 border-custom-blue"
                : ""
            }`}
            onClick={() =>
          ...
          <div
            className={`cursor-pointer ${
              selectedImage ===
              "https://m.media-amazon.com/images/I/51ZWOI8LxiS._SX522_.jpg"
                ? "border-4 border-custom-blue"
                : ""
            }`}
            onClick={() =>
          ...
          >
            <Image
              alt="dsf"
              src="https://m.media-amazon.com/images/I/51ZWOI8LxiS._SX522_.jpg"
              width={`${
                selectedImage ===
                "https://m.media-amazon.com/images/I/51ZWOI8LxiS._SX522_.jpg"
                  ? 120
