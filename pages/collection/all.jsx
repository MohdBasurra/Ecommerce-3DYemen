  ...
  return (
    <>
      <div className="parent flex w-full ">
        ...
        <div className="child1 filletring "></div>
        <div className="products flex flex-row  w-full justify-center items-center">
          <div className="card  flex w-1/8 flex-wrap     justify-center items-center ">
            {data.resources.map((resource, index) => {
              return (
                <div key={index} class=" card  m-2 bg-lightBlue ">
