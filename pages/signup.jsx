  ...
  return (
    <>
     ...
     //   value={selectedGovernment}
        ...
        className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:custom-blue focus:border-custom-blue block w-full p-2.5  dark:placeholder-gray-400  focus:bg-lightBlue"
        required
      >
